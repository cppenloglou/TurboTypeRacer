...
public class LevelsScreenController {
    ...
    @FXML
    void initialize() {
        assert goBackButton != null : "fx:id=\"goBackButton\" was not injected: check your FXML file 'LevelsScreen-view.fxml'.";
        assert tilePane != null : "fx:id=\"tilePane\" was not injected: check your FXML file 'LevelsScreen-view.fxml'.";
        initializeLevels();
    }
